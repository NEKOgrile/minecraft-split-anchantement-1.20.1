package net.nekogrile.splitanchante.screen;

import net.nekogrile.splitanchante.block.ModBlocks;
import net.nekogrile.splitanchante.block.entity.EnchantementTheft;
...
public class EnchantementTheftMenu extends AbstractContainerMenu {
    public final EnchantementTheft blockEntity;
    private final Level level;
    private final ContainerData data;

    public EnchantementTheftMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public EnchantementTheftMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ENCHANTEMENT_THEFT_MENU.get(), pContainerId);
        checkContainerSize(inv, 3);
        blockEntity = ((EnchantementTheft) entity);
    ...
    public boolean isCrafting() {
        return data.get(0) > 0 && canStartProcessing();
    }
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 3;  // Nous avons maintenant trois slots
    @Override
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ENCHANTEMENT_THEFT.get());
    }
